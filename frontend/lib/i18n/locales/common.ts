...
export const common: NamespaceDict = {
  ko: {
    ...
    loginGoogleUnconfigured: "Google OAuth 미설정. DEV 로그인을 사용하세요.",
    devSignup: "DEV 회원가입",
    devLogin: "DEV 로그인",
  ...
  en: {
    ...
    loginGoogleUnconfigured: "Google OAuth is not configured. Please use DEV login.",
    devSignup: "DEV Sign Up",
    devLogin: "DEV Log In",
  ...
  ja: {
    ...
    loginGoogleUnconfigured: "Google OAuthが未設定です。DEVログインをご利用ください。",
    devSignup: "DEV新規登録",
    devLogin: "DEVログイン",
